...
function getProductsFromServer() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios.get('/api/getProduct')];
                case 1:
                    data = (_a.sent()).data;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log(id);
                    return [4 /*yield*/, axios.get("/api/" + id)];
                case 1:
                    data = (_a.sent()).data;
                    console.log(data);
                    ok = data.ok, item = data.item;
                    console.log(item[0]);
                    if (ok === true) {
...
function renderOneItemFromServer() {
    var rootItem = document.querySelector('.rootItem');
    var local = localStorage.getItem("item");
    var item = JSON.parse(local);
    console.log(item);
    rootItem.innerHTML = "\n    <div>\n        <h2>" + item.name + "</h2>\n        <p>" + item.price + "$</p>\n        <p>" + item.desc + "</p>\n    </div>\n    ";
}
